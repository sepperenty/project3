        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="col-md-12">
                    ...
                    <div class="element">
                        <img src="/images/medium/{{$project->foto}}.jpg" alt="Foto van {{$project->user->name}} als titel {{ $project->title }}">
                        <div class="content">
                            <h1 class="uppercas">Titel</h1>
                            <hr>
                            <h1>{{ $project->title }}</h1>
                        </div>

                    </div>
                    <div class="content-body"><h1 >Overzicht van het project</h1></div>
                </div>
            </div>
        </div>
    </div>
